'''
THIS IS A CODE WRITTEN WITH SPECIFIED OBJECTIVES (GAME RULES AND CLASSES TO DEFINE) FROM PYTHON COURSE
'''
...
ranks = ('Two', 'Three', 'Four', 'Five', 'Six', 'Seven', 'Eight', 'Nine', 'Ten', 'Jack', 'Queen', 'King',
         'Ace')  # Ranks for regular deck of cards
values = {'Two': 2, 'Three': 3, 'Four': 4, 'Five': 5, 'Six': 6, 'Seven': 7, 'Eight': 8, 'Nine': 9, 'Ten': 10,
          'Jack': 10, 'Queen': 10, 'King': 10, 'Ace': 11}
# Values for each rank, special cards has value of 10 in BlackJack, while Aces can be either 1 or 11
